        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                */
                ...
                long rowId = DeepLife.myDATABASE.updateMainUser(currMainUser);
                ...
                if (rowId > 0) {
                    ...
                    logs.setValue("1");  // briggsm: looks like task VALUE never used/needed either, cuz there will only ever be 1 mainUser. (just set to 1 so other checks don't crash...)
